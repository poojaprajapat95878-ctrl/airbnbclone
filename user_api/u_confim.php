...
$check_status = $rstate->query("select * from tbl_book where add_user_id=".$uid." and id=".$book_id." and book_status='Booked'")->num_rows;
if($check_status != 0)
{
 $table="tbl_book";
...
$h = new Estate();
 ...
 $returnArr = array("ResponseCode"=>"200","Result"=>"true","ResponseMsg"=>"Property Booking Confirmed Successfully!");
...
$content = array(
       "en" => $name.', Your Booking #'.$book_id.' Has Been Confirmed Successfully.'
   );
$heading = array(
...
$descriptions = 'Booking #'.$book_id.' Has Been Confirmed Successfully.';
...
{
	 $returnArr = array("ResponseCode"=>"401","Result"=>"false","ResponseMsg"=>"Property Booked Status First Required!!");    
}
}
