            ...
            <table class="display" id="basic-1">
                        <thead>
                          <tr>
                                        ...
                                        <tbody>
                                           <?php 
										$city = $rstate->query("select * from tbl_staff");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										   ...
										   <a href="add_staff.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
