...
if(isset($_GET['id']))
{	
	if ($_SESSION['stype'] == 'Staff' && !in_array('Update', $coupon_per)) {
...
{
if ($_SESSION['stype'] == 'Staff' && !in_array('Write', $coupon_per)) {
            ...
            <div class="row">      
               <div class="col-sm-12">
				...
				<div class="card-body">
				 ...
				 if(isset($_GET['id']))
				 {
					 $data = $urban->query("select * from tbl_coupon where id=".$_GET['id']."")->fetch_assoc();
					 ?>
    ...
    maxlength="8" name="coupon_code" required  value="<?php echo $data['c_title'];?>"  oninput="this.value = this.value.toUpperCase()">
							 ...
							 <div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
								<div class="form-group mb-3">
									...
									<input type="text"  class="form-control"  name="title" value="<?php echo $data['ctitle'];?>"required >
								</div>
							</div>
...
<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
								<div class="form-group mb-3">
									...
									<textarea class="form-control" rows="5" name="description"  style="resize: none;"><?php echo $data['c_desc'];?></textarea>
								</div>
							</div>							
