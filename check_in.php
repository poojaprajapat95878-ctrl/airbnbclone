                        ...
                        <tbody>
                           <?php 
										...
										while($row = $city->fetch_assoc())
										{
										  ...
										  <button class="btn btn-success drop" style="float: none; margin: 5px;" data-id="<?php echo $row['id'];?>" data-status="Completed"  data-type="update_status" coll-type="Check_out">Check Out</button>
