...
if ($_SESSION['stype'] == 'Staff' && !in_array('Read', $gal_per)) {
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-body-wrapper">
		...
		else 
		{
                        ...
                        <tbody>
                           <?php 
										$city = $rstate->query("select * from tbl_gallery");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											...
											<tr>
                                              ...
                                              <td class="align-middle">
                                                   <?php $pro = $rstate->query("select * from tbl_property where id=".$row['pid']."")->fetch_assoc();echo $pro['title'];?>
                                                </td>
												
												<td class="align-middle">
                                                   <?php $pro = $rstate->query("select * from tbl_gal_cat where id=".$row['cat_id']."")->fetch_assoc();echo $pro['title'];?>
                                                </td>
												...
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $gal_per)) {
				?>
										   ...
										   <a href="add_gal.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
