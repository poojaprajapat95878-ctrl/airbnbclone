...
if ($_SESSION['stype'] == 'Staff' && !in_array('Read', $country_per)) {
...
?>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-body-wrapper">
		...
		{
			if (in_array('Update', $country_per)) {
			?>
			<th>Action</th>
			<?php
			}			
		...
		else 
		{
                        ...
                        <tbody>
                           <?php 
										$city = $rstate->query("select * from tbl_country");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											...
											<tr>
                                                ...
                                                <td class="align-middle">
                                                   <?php echo $rstate->query("select * from tbl_property where country_id=".$row['id']."")->num_rows;?>
                                                </td>
												...
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $country_per)) {
				?>
										   ...
										   <a href="add_country.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
