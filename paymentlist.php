...
if ($_SESSION['stype'] == 'Staff' && !in_array('Read', $payment_per)) {
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-body-wrapper">
                          ...
                          <tr>
                                               ...
                                               <th>Payment <br>Gateway <br>Name</th>
                                                ...
                                                <th>Payment <br>Gateway <br>Status</th>
												 ...
												 <th>Show <br>On <br>Subscribe?</th>
                                                <?php 
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $payment_per)) {
			?>
			<th>Action</th>
			<?php
			}			
		...
		else 
		{
                                        ...
                                        <tbody>
                                           <?php 
											 $stmt = $rstate->query("SELECT * FROM `tbl_payment_list` where id!=5");
$i = 0;
