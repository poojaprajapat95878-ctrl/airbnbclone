            ...
            <div class="row">      
              ...
              <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $rstate->query("select * from tbl_book where add_user_id=0 and book_status='Confirmed'");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										  ...
										  <button class="btn btn-success drop" style="float: none; margin: 5px;" data-id="<?php echo $row['id'];?>" data-status="Check_in"  data-type="update_status" coll-type="Check_in">Check In</button>
