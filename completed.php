            ...
            <div class="row">      
              ...
              <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $rstate->query("select * from tbl_book where add_user_id=0 and book_status='Completed'");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											...
											{
												?>
												<b>No Rating Provide</b>
												<?php 
											}
											else if($row['total_rate'] == 1)
											{
												?>
												<div class="star-rating">★</div>
												<?php 
											}
											else if($row['total_rate'] == 2)
											{
												?>
												<div class="star-rating">★★</div>
												<?php 
											}
											else if($row['total_rate'] == 3)
											{
												?>
												<div class="star-rating">★★★</div>
												<?php 
											}
											else if($row['total_rate'] == 4)
											{
												?>
												<div class="star-rating">★★★★</div>
												<?php 
											...
											{
												?>
												<b>No FeedBack Provide</b>
												<?php 
											}
											else 
											{
												echo '<b>'.$row['rate_text'].'</b>';
											}
											?>
