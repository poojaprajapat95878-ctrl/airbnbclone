...
if ($_SESSION['stype'] == 'Staff' && !in_array('Read', $gcat_per)) {
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-body-wrapper">
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h3>
                    Gallery Category List Management</h3>
                </div>
                <div class="col-6">
              ...
              <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        <thead>
                          <tr>
                            <th>Sr No.</th>
							<th>Gallery Category Title</th>
											<th>Property Title</th>
												<th>Gallery Category Status</th>
												<?php 
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $gcat_per)) {
			?>
			<th>Action</th>
			<?php
			}			
		...
		else 
		{
                        ...
                        <tbody>
                           <?php 
										$city = $rstate->query("select * from tbl_gal_cat");
										$i=0;
												...
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $gcat_per)) {
				?>
										   ...
										   <a href="ad_gal_cat.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
